...
function HomePage() {
  ...
  return (
    <SafeAreaView style = {styles.container}>
      <CurrentDate isHomePage = {true}/>
      <View>
      <Svg width="342" height="315" viewBox="0 0 342 315" fill="none" xmlns="http://www.w3.org/2000/svg" style = {styles.svgContainer}>
        <Rect x="2.5" y="2.5" width="337" height="310" rx="37.5" fill="#FF5A5F" stroke="black" strokeWidth="5"/>
        ...
        <View style = {styles.switcher}>
          <Text style = {styles.textBold}>Tasks for the: </Text>
          <SegmentedControl
          values={['day', 'week']}
